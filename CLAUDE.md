...
Work from project documents, one task at a time. Do not expand scope or modify secrets.

GitNexus is the required memory/index layer when available through the configured agent environment.
...
This project is indexed by GitNexus as **docker-image-watcher** (598 symbols, 864 relationships, 27 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
