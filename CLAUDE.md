...
This project is indexed by GitNexus as **docker-image-watcher** (624 symbols, 925 relationships, 33 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
