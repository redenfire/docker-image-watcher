...
This project is indexed by GitNexus as **docker-image-watcher** (586 symbols, 851 relationships, 27 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
